      ...
      <a-layout-content style="background-color: white">
        <a-card class="hellocard" :bordered="false">
          ...
          <a-breadcrumb>
            ...
            <a-breadcrumb-item style="color: white"><a @click="$router.push('/assessment')" style="color: white">Skill
              Verification</a></a-breadcrumb-item>
            <a-breadcrumb-item style="color: white"><a @click="$router.push('/selectassesment')" style="color: white">Project
              based test </a></a-breadcrumb-item>
            <a-breadcrumb-item style="color: white"><a @click="$router.push('/developerprojects')" style="color: white">My Self test Projects</a></a-breadcrumb-item>
            <a-breadcrumb-item style="color: white">{{ application.project.name }}</a-breadcrumb-item>

          </a-breadcrumb>

          <span style="font-size: 1.7rem;font-family: sofia_prosemibold;margin-bottom: 0;color: white">
                {{ application.project.name }}</span>
              ...
              <div style="border:1px solid #e8e8e8;;padding: 2%;">
                <div v-if="$store.state.user.email === 'codeln.workspaces@gmail.com'">
                  ...
                  <a-button type="primary" size="small"
                            @click="navigateTo({name:'ReportSample',params:{projectId:application.project.id}})">
                    sample
                  </a-button>
                </div>
