                ...
                <a-row gutter="8">
                    <a-col :span="14">
                        ...
                        <a-carousel v-if="application.project.hasvideo === false" autoplay style="border:1px solid #e8e8e8;">
                            <div v-if="application.project.projectimage1 "><img style="width: 100%" :src="application.project.projectimage1"/>
                            </div>
                            <div v-if="application.project.projectimage2 "><img style="width: 100%" :src="application.project.projectimage2"/>
                            </div>
                            <div v-if="application.project.projectimage3 "><img style="width: 100%" :src="application.project.projectimage3"/>
                            </div>
                        ...
                        <div v-if="application.project.hasvideo">
                            <youtube :video-id="application.project.projectimage2" :player-vars="playerVars"></youtube>
                        </div>
                    ...
                    <a-col :span="10" style="padding: 0 1%;">
                        <div style="border:1px solid #e8e8e8;;padding: 2%;">
                            ...
                            <div style="margin-left: 5%;margin-bottom: 2%" v-if="application.stage==='invite_accepted'">
                            ...
                            <div>
                                ...
                                <ol>
                                    <li v-if="application.project.requirement1">{{application.project.requirement1}}</li>
                                    <li v-if="application.project.requirement2">{{application.project.requirement2}}</li>
                                    <li v-if="application.project.requirement3">{{application.project.requirement3}}</li>
                                    <li v-if="application.project.requirement4">{{application.project.requirement4}}</li>
                                    <li v-if="application.project.requirement5">{{application.project.requirement5}}</li>
                                    <li v-if="application.project.requirement6">{{application.project.requirement6}}</li>
                                    <li v-if="application.project.requirement7">{{application.project.requirement7}}</li>
                                    <li v-if="application.project.requirement8">{{application.project.requirement8}}</li>
                                    <li v-if="application.project.requirement9">{{application.project.requirement9}}</li>
                                    <li v-if="application.project.requirement10">{{application.project.requirement10}}</li>
    ...
    export default {
        ...
        methods :{
            ...
            async Settime(application_id){
                ...
                Projects.myprojectdetailspatch(application_id, {stage:'time_set',projectstarttime: this.projectstarttime}, auth)
            },
