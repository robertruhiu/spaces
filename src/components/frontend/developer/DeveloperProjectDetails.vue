    ...
    <a-layout-content style="background-color: white">
      <a-card class="hellocard" :bordered="false">
        ...
        <a-breadcrumb>
          ...
          <a-breadcrumb-item style="color: white"><a @click="$router.push('/manageapplications')" style="color: white">Manage Applications </a></a-breadcrumb-item>
          <a-breadcrumb-item style="color: white"> {{ project.name }}</a-breadcrumb-item>
