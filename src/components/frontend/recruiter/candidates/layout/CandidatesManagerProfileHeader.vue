            ...
            <a-row>
                <a-col :span="24">
                            <span>
                                ...
                                <span style="float: right" v-if="applicant.test_stage ==='complete'">
                    ...
                    Application Stage :
                        ...
                        <a-tag color="#BA68C8" style="text-align: center;width: 4rem;">
                            {{applicant.stage}}
                        </a-tag>
                    </p>
...
<script>
    ...
    export default {
        ...
        async mounted() {
            ...
            this.applicant = (await Marketplace.retrievecandidate(this.$route.params.applicationId, auth)).data
