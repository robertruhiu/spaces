                ...
                <div>
                    <a-row gutter="8" style="margin-top: 4rem;padding: 3%">
                        <a-col span="8"  v-for="item in filteredList" v-bind:key="item" >
                            ...
                            <a @click="navigateTo({name:'mypickedprojectdetails',params:{projectId:item.id,candidateId: application.developer.id,
...
<script>
    ...
    import RecruiterSider from '@/components/layout/RecruiterSider';
